...
const messages = {
  es: {
    ...
    results: 'ofertas', loadingJobs: 'Cargando ofertas…', loadingJobsCopy: 'Conectando con las fuentes. Aparecerán aquí en unos segundos.',
    updated: 'Actualizado', cached: 'Datos guardados', save: 'Guardar', apply: 'Solicitar',
  ...
  en: {
    ...
    results: 'jobs', loadingJobs: 'Loading jobs…', loadingJobsCopy: 'Connecting to job sources. Listings will appear here shortly.',
    updated: 'Updated', cached: 'Saved data', save: 'Save', apply: 'Apply',
